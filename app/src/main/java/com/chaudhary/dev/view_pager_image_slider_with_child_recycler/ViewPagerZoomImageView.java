...
/**
 * ViewPagerZoomImageView is a pinch-to-zoom extension of {@link ImageView}, providing a smooth
 ...
 * visible window.
 */
public class ViewPagerZoomImageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    public ViewPagerZoomImageView (Context context) {
        super(context);
        init(context, null);
    }

    public ViewPagerZoomImageView (Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ViewPagerZoomImageView (Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray values = context.obtainStyledAttributes(attrs, com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView);

        zoomable = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_zoomable, true);
        translatable = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_translatable, true);
        animateOnReset = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_animateOnReset, true);
        autoCenter = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_autoCenter, true);
        restrictBounds = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_restrictBounds, false);
        doubleTapToZoom = values.getBoolean(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_doubleTapToZoom, true);
        minScale = values.getFloat(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_minScale, MIN_SCALE);
        maxScale = values.getFloat(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_maxScale, MAX_SCALE);
        doubleTapToZoomScaleFactor = values.getFloat(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_doubleTapToZoomScaleFactor, 3);
        autoResetMode = AutoResetMode.Parser.fromInt(values.getInt(com.chaudhary.dev.view_pager_image_slider_with_child_recycler.R.styleable.ZoomageView_zoomage_autoResetMode, AutoResetMode.UNDER));
